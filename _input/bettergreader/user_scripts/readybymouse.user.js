// ==UserScript==
// @name           Read by Mouse
// @description    Adds a button to the bottom bar that toggles Google Reader in and out of a "mouse-only" mode that allows for easy and customizable reading via the mouse buttons (next item = left button, previous item = right button, open in tab/star/share/tag with middle button).
// @version        1.1
// @date           2009-02-28
// @author        Ryan Williams
// @include       htt*://www.google.*/reader/*
// @homepage http://userscripts.org/scripts/show/8843
// @versionorlastupdate Mar 1 2009
...
// Changelog
// ---------
// v1.1     28-Feb-2009 - Fixed the click events and started using jquery for several tasks
// v1.0     06-Nov-2008 - Page loads with controls set to their previous On/Off setting (note: there's nothing especially special that makes this a 1.0 release - it's just the auto-update code I use wants the versioning in this format)
// v0.9     04-Nov-2008 - Updated to work with some changes Google made to Reader 
...
//Gina Trapani: removed autoupdate code
...
if (GM_getValue)
{
	systemStatus = GM_getValue('rbmStatus', 'Off');
...
if (nearNewButton)
{
    ...
    mouseCtrlButton.innerHTML = '<input type="button" id="___mouseCtrl" value="ReadByMouse ' + systemStatus + '" style="margin-left: 10px;"></input><span style="margin-left: 10px;">Middle click: </span><select id="___middleClickSettings" name="midClickSettings" style="margin-left: 5px;"><option id="openInTab" value="openInTab">Opens in Tab<option id="share" value="share">Shares<option id="star" value="star">Stars<option id="addTag" value="addTag">Add a Tag</select><span id="addTagSpan" style="text-align:left; visibility: collapse; margin-left: 10px;">Tag: <input type="textbox" id="txtTag" value=""></span>';
...
function openInTab()
{
	...
	var currentEntry = $("#current-entry .entry-title-link");
...
function tagItem1()
{
    var currentEntry = $("#current-entry .entry-actions .entry-tagging-action-title");
...
function tagItem2()
{
	...
	$(".tags-edit .tags-edit-tags").val($(".tags-edit .tags-edit-tags").val() + $("#txtTag").val()); //document.getElementById('tags-container-template');
			

	var popup = $(".tags-edit .tags-edit-buttons").find(".goog-button-body"); //document.getElementById('tags-container-template');
	
	simulateClick(popup[0]);
}
