// ==UserScript==
// @name           YouTube Alternate Video Player (No Autoplay)
...
// @author Yansky
// @homepage http://userscripts.org/scripts/show/13955
...
function timedCount(){
	...
	if( ( iCanHazSpanna && document.getElementById('tempLoader') )== null){
		...
		pD.innerHTML = '<div id="tempLoader" style="position:relative;width:480px;height:395px;"><p style="position:relative;top:50%;left:40%;font-weight:bold;">Loading FlowPlayer &nbsp; '+
		...
		'src="http://gmflowplayer.googlecode.com/files/FlowPlayer.swf" id="FlowPlayer" name="FlowPlayer" bgcolor="#ffffff" '+
		'quality="high" allowscriptaccess="always" allowfullscreen="true" flashvars="config={ '+
		'playList: [ { url: \'http://img.youtube.com/vi/'+vidID+'/default.jpg\', overlayId: \'play\' }, { url: \''+spanTex+'\' '+
		'}],showPlayListButtons:false, initialScale: \'scale\', showLoopButton: false, allowResize: true, useNativeFullScreen:true'+
