...
Based heavily Anthony Lieuallen's (single) "script compiler":http://arantius.com/misc/greasemonkey/script-compiler 
...
* Copy the @config.inc.php@ file into your new directory. In it, fill in your extension's name, description, GUID, and all other required bits of information.  For example:
